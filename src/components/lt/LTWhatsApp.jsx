export default function LTWhatsApp() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener"
      className="fixed bottom-6 right-6 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg z-40 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_30px_rgba(37,211,102,0.5)] animate-[waPulse_2s_ease-in-out_infinite]"
